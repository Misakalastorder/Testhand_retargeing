...
if hand_brand == 'yumi':
    ...
    # 迁移新项目后的路径
    urdf_file = "D:\\2026\\code\\test_other\\Testhand_retargeing\\hand_pose_retargeting-main\\pose_retargeting\\optimization\\model\\linkerhand_l21_right.urdf"
...
损失函数权重
'''
loss_weight = [500, 50, 0, 0, 10] # 侧摆损失，指尖损失，碰撞损失，大拇指损失，指尖距离损失
col_threshold = 0.010